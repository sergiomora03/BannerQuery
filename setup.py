...
setup(
  name = 'Banner',         # How you named your package folder (MyLib)
  packages = ['Banner'],   # Chose the same as "name"
  ...
  url = 'https://github.com/sergiomora03/BANNER',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/sergiomora03/BANNER/archive/v_01.tar.gz',    # I explain this later on
